...
var sqlQuery = "SELECT the_geom, description, name, personal_opinion FROM lab_3b_jemin";
function addPopup(feature, layer) {
    layer.bindPopup(
        "<b>" + feature.properties.name + "</b><br>" +
        feature.properties.description + "<br>" +
        feature.properties.personal_opinion
    );
}
...
function setData(e) {
    ...
    if(e.target && e.target.id == "submit") {
        ...
        drawnItems.eachLayer(function(layer) {
                ...
                var sql =
                    "INSERT INTO lab_3b_jemin (the_geom, name, description) " +
